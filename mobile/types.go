...
func (h *Header) GetNUCDifficulty() *BigInt { return &BigInt{h.header.NUCDifficulty} }
...
func (h *Header) GetCoinbaseTxs() []byte    { return h.header.CoinbaseTxs }
func (h *Header) GetVersion() uint32        { return h.header.Version }
