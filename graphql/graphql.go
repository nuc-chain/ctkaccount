...
func (b *Block) NUCDifficulty(ctx context.Context) (hexutil.Big, error) {
	header, err := b.resolveHeader(ctx)
	if err != nil {
		return hexutil.Big{}, err
	}
	return hexutil.Big(*header.NUCDifficulty), nil
}
...
func (b *Block) Version(ctx context.Context) (uint32, error) {
	header, err := b.resolveHeader(ctx)
	if err != nil {
		return 0, err
	}
...
func (b *Block) CoinbaseTxs(ctx context.Context) (hexutil.Bytes, error) {
	header, err := b.resolveHeader(ctx)
	if err != nil {
		return hexutil.Bytes{}, err
	}
	return hexutil.Bytes(header.CoinbaseTxs), nil
}
