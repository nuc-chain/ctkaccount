...
var (
	DifficultyBoundDivisor = big.NewInt(64)     // The bound divisor of the difficulty, used in the update calculations.
	GenesisDifficulty      = big.NewInt(131072) // Difficulty of the Genesis block.
	GenesisNUCDifficulty   = big.NewInt(131072) // Difficulty of the Genesis block.
