...
func TestRemoteNotify(t *testing.T) {
	...
	header := &types.Header{Number: big.NewInt(1), Difficulty: big.NewInt(100),NUCDifficulty:big.NewInt(100)}
...
func TestRemoteMultiNotify(t *testing.T) {
	...
	for i := 0; i < cap(sink); i++ {
		header := &types.Header{Number: big.NewInt(int64(i)), Difficulty: big.NewInt(100),NUCDifficulty:big.NewInt(100)}
		block := types.NewBlockWithHeader(header)
...
func TestStaleSubmission(t *testing.T) {
	...
	testcases := []struct {
		...
		{
			[]*types.Header{
				{ParentHash: common.BytesToHash([]byte{0xa}), Number: big.NewInt(1), Difficulty: big.NewInt(100000000),NUCDifficulty:big.NewInt(100000000)},
			},
			0,
			true,
		},
		...
		{
			[]*types.Header{
				{ParentHash: common.BytesToHash([]byte{0xb}), Number: big.NewInt(2), Difficulty: big.NewInt(100000000),NUCDifficulty:big.NewInt(100000000)},
				{ParentHash: common.BytesToHash([]byte{0xb}), Number: big.NewInt(2), Difficulty: big.NewInt(100000001),NUCDifficulty:big.NewInt(100000001)},
			},
			0,
			true,
		},
		...
		{
			[]*types.Header{
				{ParentHash: common.BytesToHash([]byte{0xc}), Number: big.NewInt(3), Difficulty: big.NewInt(100000000),NUCDifficulty:big.NewInt(100000000)},
				{ParentHash: common.BytesToHash([]byte{0xd}), Number: big.NewInt(9), Difficulty: big.NewInt(100000000),NUCDifficulty:big.NewInt(100000000)},
			},
			0,
			true,
		},
		...
		{
			[]*types.Header{
				{ParentHash: common.BytesToHash([]byte{0xe}), Number: big.NewInt(10), Difficulty: big.NewInt(100000000),NUCDifficulty:big.NewInt(100000000)},
				{ParentHash: common.BytesToHash([]byte{0xf}), Number: big.NewInt(17), Difficulty: big.NewInt(100000000),NUCDifficulty:big.NewInt(100000000)},
			},
			0,
			false,
		},
