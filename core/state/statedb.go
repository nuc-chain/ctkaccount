...
// Retrieve the balance from the given address or 0 if object not found
func (s *StateDB) GetAllPocBalance(addr common.Address) *big.Int {
	stateObject := s.getStateObject(addr)
	if stateObject != nil {
		return stateObject.AllPocBalance()
	}
	return common.Big0
}
...
// AddBalance adds amount to the account associated with addr.
func (s *StateDB) AddAllPocBalance(addr common.Address, amount *big.Int) {
	stateObject := s.GetOrNewStateObject(addr)
	if stateObject != nil {
		stateObject.AddAllPocBalance(amount)
	}
}
...
func (s *StateDB) Suicide(addr common.Address) bool {
	...
	stateObject.data.AllPocBalance = new(big.Int)
...
func (s *StateDB) CreateAccount(addr common.Address) {
	...
	if prev != nil {
		...
		newObj.SetAllPocBalance(prev.data.AllPocBalance)
	}
}
